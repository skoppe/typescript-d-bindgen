...
import { hasTypeGotHandle, mangleFunctionName, mangleMethod, FunctionKind, isVoid, isLiteralOrUndefinedType} from './utils'
...
function generateResultEncoding(returnType: ir.Type, expression: string) : string {
    ...
    // TODO: call proper encode for type
